        ...
        <div className="main-container">
          ...
          <div className="main-calendar">
            {showCalendar ? (
              ...
              <SchedulerComponent events={eventList} onEventClick={handleEventClick}/>
            )}
          </div>
          {selectedGroup && (
            <div className="schedule-form">
              ...
              <form onSubmit={handleSubmit}>
                <input type="date" name="date" value={scheduleData.date} onChange={handleChange} required />
                <input type="text" name="description" value={scheduleData.description} onChange={handleChange} placeholder="Description" required />
                <input type="time" name="startTime" value={scheduleData.startTime} onChange={handleChange} required />
                <input type="time" name="endTime" value={scheduleData.endTime} onChange={handleChange} required />
